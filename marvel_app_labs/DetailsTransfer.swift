import UIKit
import SnapKit
final class DetailsTransferController: UIPresentationController{
    private lazy var closeButtonContainer: UIVisualEffectView = {
            let closeButtonEffectView = UIVisualEffectView(effect: blurEffect)
        ...
        closeButtonEffectView.contentView.addSubview(button)
            ...
            closeButtonEffectView.layer.cornerRadius = 20
            closeButtonEffectView.clipsToBounds = true
            closeButtonEffectView.snp.makeConstraints { make in
                make.width.equalTo(48)
                make.height.equalTo(48)
            }
            return closeButtonEffectView
        }()
...
extension DetailsTransferController {
...
final class DetailsTransferManager: NSObject, UIViewControllerTransitioningDelegate {
    ...
    func presentationController(forPresented presented: UIViewController,
        ...
        return DetailsTransferController(presentedViewController: presented, presenting: presenting)
    }
    func animationController(forPresented presented: UIViewController,
                             presenting: UIViewController,
                             source: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        DetailsAnimationController(animationType: .present, anchorView: anchorView)
    }
    func animationController(forDismissed dismissed: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        DetailsAnimationController(animationType: .dismiss, anchorView: anchorView)
    }
}
final class DetailsAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
